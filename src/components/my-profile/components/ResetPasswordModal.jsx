      ...
      <div className="flex flex-col gap-4 justify-between px-6 pb-6">
        <div className="flex flex-col gap-4 justify-center items-center">
          <div className="flex flex-col gap-2 justify-center items-center">
            ...
            <span className="text-base text-[var(--color-grey-600)]">
          ...
          <form onSubmit={handleSubmit} className="w-full mt-6 space-y-4">
            <div>
              ...
              {errors.currentPassword && (
                <p className="text-[var(--color-red)] text-xs mt-1">{errors.currentPassword}</p>
              )}
            </div>
            ...
            <div>
              ...
              />
              {errors.newPassword && (
                <p className="text-[var(--color-red)] text-xs mt-1">{errors.newPassword}</p>
              )}
            </div>
            ...
            <div>
              ...
              {errors.confirmPassword && (
                <p className="text-[var(--color-red)] text-xs mt-1">{errors.confirmPassword}</p>
              )}
              ...
              {passwordsMatch && (
                <div className="flex items-center gap-1.5 mt-2">
                  ...
                  <span className="text-xs font-normal text-[var(--color-green)]">
                    Passwords match
                  </span>
                </div>
              )}
              ...
              {passwordsMismatch && (
                <div className="flex items-center gap-1.5 mt-2">
                  ...
                  <span className="text-xs font-normal text-[var(--color-red)]">
