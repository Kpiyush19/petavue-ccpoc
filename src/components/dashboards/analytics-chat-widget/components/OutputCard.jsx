...
export default function OutputCard({
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <button
        className={twMerge(
          'flex h-[69px] w-[407px] items-center border hover:bg-[var(--color-primary-50)] bg-white rounded-lg my-[4px] relative',
          isSelected
      ...
      >
        <div className="flex justify-center items-center w-[69px] h-full shrink-0">
          <div className="flex h-[52px] w-[52px] m-auto bg-[var(--color-grey-50)] border border-[var(--color-grey-200)] rounded-lg justify-center items-center">
            {isLoading ? (
              <img
              ...
              <Icon size={24} className="text-[var(--color-grey-600)]" />
            )}
          </div>
        </div>
        ...
        <div className="flex flex-col w-full h-full justify-center items-start overflow-x-hidden rounded-lg gap-1.5">
          <div className="flex w-full overflow-auto">
            <Tooltip
              ...
              title={displayTitle}
            >
              <span className="text-[var(--color-text-primary)] mx-2 font-medium whitespace-nowrap overflow-hidden text-ellipsis">
                {displayTitle}
              </span>
            </Tooltip>
          </div>
          <span className="text-[var(--color-grey-400)] text-xs mx-2">
            {isLoading
              ? 'Generating...'
        ...
        {isSelected && (
          <>
            <span className="absolute top-[-9px] right-[-9px] bg-[var(--color-grey-50)] w-[13px] h-[13px]" />
