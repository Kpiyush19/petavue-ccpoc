              ...
              <div className="widget-access-dialog__accordion">
                ...
                >
                  <div className="widget-access-dialog__accordion-left">
                    <Info size={12} weight="regular" color="var(--color-grey-600)" />
                    <span className="widget-access-dialog__accordion-label">
                      Additional information
                    </span>
                  </div>
                  {infoOpen
                    ? <CaretUp size={12} weight="regular" color="var(--color-grey-600)" />
                    : <CaretDown size={12} weight="regular" color="var(--color-grey-600)" />
                  }
                </button>
      ...
      <div className="dashboard-widget__header">
        {editing && (
          <span className="dashboard-widget__drag-handle">
            <DotsSixVertical size={16} weight="bold" color="var(--color-grey-300)" />
          </span>
        )}
