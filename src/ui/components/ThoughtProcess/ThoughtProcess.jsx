      ...
      >
        ...
        <div className="thought-process__header-right">
          {isLoading ? (
            ...
            <>
              <CheckCircle size={16} weight="regular" color="var(--color-green)" />
              {expanded ? (
                <CaretUp size={16} weight="regular" color="var(--color-grey-600)" />
              ) : (
                <CaretDown size={16} weight="regular" color="var(--color-grey-600)" />
              )}
            </>
          )}
        </div>
